...
5. `scripts/generate_simulation.py` - validation gate before HTML generation.
6. `scripts/run_smoke_tests.py` - positive and negative smoke coverage.
7. `docs/review/status.md` - current implementation status.
8. `docs/review/known-limitations.md` - known gaps to prioritize.
